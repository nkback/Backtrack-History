...
@section('content')
    ...
    <!-- Header -->
    <header id="header">
        <h1 id="logo"><a href="/">Backtrack History</a></h1>
        <nav id="nav">
            <ul>
                <li><a href="/">Home</a></li>
                <li>
    ...
    <section id="banner">
        <div class="content">
            <header>
                <h2>Backtrack History</h2>
                <p>And there are no hoverboards or flying cars.<br />
                    Just apps. Lots of mother flipping apps.</p>
            </header>
            <span class="image"><img src="images/stu-cartoon.jpg" alt="" /></span>
        </div>
    ...
    <section id="two" class="spotlight style2 right">
        <span class="image fit main"><img src="images/bgmaps.jpg" alt="" /></span>
        <div class="content">
            <header>
    ...
    <section id="three" class="spotlight style3 left">
        <span class="image fit main bottom"><img src="images/bgfaces.jpg" alt="" /></span>
        <div class="content">
            <header>
